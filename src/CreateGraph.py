...
########## CREATE EDGES IN SCAFFOLD GRAPH ##########
            ...
            #if contig1 == 'contig2,6001,0' and contig2 == 'contig1,3001,0' or contig2 == 'contig2,6001,0' and contig1 == 'contig1,3001,0':
            #    print 'LINK!!', alignedread.flag
            ...
            if contig1 != contig2 and alignedread.is_read2:
                ...
                if contig1 in Contigs and contig2 in Contigs and Contigs[contig2].scaffold != Contigs[contig1].scaffold and alignedread.mapq  > 10: # and alignedread.tags[0][1] == 'U':
...
#        print 'NR OF FISHY EDGES: ', len(fishy_reads)
    ...
    ##### Calc coverage for all contigs with current lib here #####
        ...
        param.std_dev_coverage = std_dev_cov
            #if param.first_lib:
            #Contigs,Scaffolds,G = RepeatDetector(Contigs,Scaffolds,G,C_dict,param)
    ...
    #### Pre filtering of edges here ####              
                #PreFilterEdges(G,Scaffolds,param)
        
        
#        if 3 == lower_bound:
#            nbrs = G.neighbors(node)
#            for nbr in nbrs:
#                print G[node][nbr]['nr_links'], nbr
...
def RepeatDetector(Contigs,Scaffolds,G,C_dict,param):
    ...
    k = ChooseQuantileDetectingRepeats(nr_of_contigs)
    ...
    Contigs = GO.PrintOutRepeats(Repeats,Contigs,output_dest,C_dict)
